...
HD_PWD='C:/Users/Administrator/Documents/GitHub/Piano2/piano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log learn_mode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source learn_mode.tcl
