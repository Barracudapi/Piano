...
HD_PWD='C:/Users/Administrator/Documents/GitHub/Piano/piano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log learning_mode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source learning_mode.tcl
