...
set rc [catch {
  ...
  add_files -quiet C:/Users/Administrator/Documents/GitHub/Piano2/piano.runs/synth_1/learn_mode.dcp
...
set rc [catch {
  ...
  catch { write_mem_info -force learn_mode.mmi }
  write_bitstream -force learn_mode.bit 
  catch {write_debug_probes -quiet -force learn_mode}
  catch {file copy -force learn_mode.ltx debug_nets.ltx}
