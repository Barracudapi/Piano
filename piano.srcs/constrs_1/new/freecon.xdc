...
set_property PACKAGE_PIN F6 [get_ports {led_state[3]}]
set_property PACKAGE_PIN G4 [get_ports {led_state[2]}]
set_property PACKAGE_PIN G3 [get_ports {led_state[1]}]
set_property PACKAGE_PIN J4 [get_ports {led_state[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {select_song[3]}]
...
set_property PACKAGE_PIN K1 [get_ports {select_song[3]}]
set_property PACKAGE_PIN H6 [get_ports {select_song[2]}]
set_property PACKAGE_PIN H5 [get_ports {select_song[1]}]
