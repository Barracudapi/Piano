...
set_property PACKAGE_PIN R11 [get_ports select_song_btn]

set_property IOSTANDARD LVCMOS33 [get_ports {led_for_ss[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {led_for_ss[0]}]
set_property PACKAGE_PIN M1 [get_ports {led_for_ss[1]}]
set_property PACKAGE_PIN K3 [get_ports {led_for_ss[0]}]
